...
public class Que5 {
	public static class map_h1 extends Mapper<LongWritable, Text, Text, Text> {
	...
	public static class red_h1 extends Reducer<Text, Text, NullWritable, Text> {
	...
	public static void main(String[] args) throws IOException,
		...
		job.setMapperClass(map_h1.class);
		job.setPartitionerClass(year_partitionerclass.class);
		job.setReducerClass(red_h1.class);
